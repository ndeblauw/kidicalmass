...
<div class="site-footer-zone relative z-10 bg-kidical-yellow pt-12">
    ...
    <footer class="site-footer">
        ...
        <div class="site-footer__main">
            ...
            {{-- Follow --}}
            <div>
                <h3 class="site-footer__col-title">{{ __('footer.columns.follow_us') }}</h3>
                <div class="site-footer__social">
                    <a href="{{ config('kidicalmass.social.instagram') }}" target="_blank" rel="noopener noreferrer" aria-label="Instagram" class="site-footer__social-link">
                    ...
                    <a href="{{ config('kidicalmass.social.facebook') }}" target="_blank" rel="noopener noreferrer" aria-label="Facebook" class="site-footer__social-link">
