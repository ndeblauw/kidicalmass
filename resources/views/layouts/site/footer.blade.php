    ...
    <div class="container mx-auto px-4">
        ...
        <div class="site-footer__main">
            ...
            <div>
                ...
                <p class="site-footer__tagline">Cycling with kids, for safer streets in every neighbourhood.</p>
            </div>
            ...
            {{-- Organisation --}}
            <div>
                <h3 class="site-footer__col-title">Organisation</h3>
                <ul class="site-footer__links">
                    <li><a href="#">About us</a></li>
                    <li><a href="#">Donate</a></li>
                    <li><a href="#">Press &amp; media</a></li>
                    <li><a href="mailto:info@kidicalmass.be">Contact</a></li>
                </ul>
            </div>
