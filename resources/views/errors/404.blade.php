...
<x-layouts::site title="Pagina niet gevonden">
    ...
    <x-error-page code="404" title="Oeps, je bent verkeerd gereden" illustration="img/illustrations/heart-30-sign.svg">
        ...
        <x-slot:actions>
            <x-cta-button :href="localized_route('home')" variant="secondary" icon="back">Naar de startpagina</x-cta-button>
        </x-slot:actions>
    </x-error-page>
    ...
    <section class="mx-auto mt-16 max-w-4xl">
        ...
        <ul class="mt-8 grid gap-6 sm:grid-cols-3" role="list">
            <li><x-nav-card :href="localized_route('activities.index')" icon="calendar-days" title="Kalender">Vind een rit in jouw buurt.</x-nav-card></li>
            <li><x-nav-card :href="localized_route('groups.index')" icon="map-pin" title="Lokale groepen">Ontdek wie er bij jou in de buurt fietst.</x-nav-card></li>
            <li><x-nav-card :href="localized_route('getting-started')" icon="face-smile" title="Voor het eerst mee">Wat je mag verwachten op een rit.</x-nav-card></li>
        </ul>
    </section>
