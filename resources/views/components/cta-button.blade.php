@props([
    ...
    'icon' => 'arrow',     // arrow (a "go" action) | back (a "return" action) | heart (support / membership) | download (a file download)
...
@php
    ...
    $iconSvg = match ($icon) {
        ...
        'download' => '<svg viewBox="0 0 14 14" fill="none" aria-hidden="true"><path d="M7 2v7M3.5 5.5 7 9l3.5-3.5M2.5 12h9" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
