...
>
    ...
    <div class="flex h-full flex-col justify-center gap-3 p-6 md:p-10">
        <h2>
            <a href="{{ localized_route('articles.show', ['article' => $article]) }}" class="link-plain text-kidical-ink transition-colors group-hover:text-kidical-blue after:absolute after:inset-0">{{ $article->title_nl }}</a>
        </h2>
