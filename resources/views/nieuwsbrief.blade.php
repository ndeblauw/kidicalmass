<x-layouts::site :title="__('newsletter.title')" :description="__('meta.newsletter')">
    ...
    <x-page-hero :eyebrow="__('newsletter.hero.eyebrow')" :title="__('newsletter.hero.title')" size="compact" illustration="img/illustrations/relaxed-rider.svg" panelClass="page-panel--newsletter">
        ...
        <div class="grid gap-10 lg:gap-x-16 md:grid-cols-[1fr_1.6fr] items-start max-w-4xl lg:max-w-5xl xl:max-w-6xl ml-0">
            <aside class="md:pt-6">
                <ul class="newsletter-signup-benefits">
                    @foreach (__('newsletter.benefits') as $benefit)
                        <li>{{ $benefit }}</li>
                    @endforeach
                </ul>
            </aside>
