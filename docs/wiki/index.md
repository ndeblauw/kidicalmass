...
| [UX Strategy](ux/_strategy.md) | Why the site exists and for whom — audiences, objectives, emotional register | UX |
| [UX Scope](ux/_scope.md) | What is and isn't in scope for the public site | UX |
| [UX Structure](ux/_structure.md) | Site structure and navigation model | UX |
| [Activity Detail — Strategy](ux/activity-detail/_strategy.md) | Strategy for the activity detail page | UX |
| [Activity Detail — Scope](ux/activity-detail/_scope.md) | Scope for the activity detail page | UX |
| [Activity Detail — Structure](ux/activity-detail/_structure.md) | Structure and layout for the activity detail page | UX |
| [Activity Detail — Skeleton](ux/activity-detail/_skeleton.md) | Skeleton / wireframe notes for the activity detail page | UX |
