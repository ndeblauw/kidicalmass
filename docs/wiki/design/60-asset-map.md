...
Brand characters and decorative elements. The nine named characters are already clean in `public/img/illustrations/` and in active use on the new site. The two additional entries below are not yet in `public/img/`.

| Filename | Description | Quality | In use | Source |
|----------|-------------|---------|--------|--------|
| `bird-with-helmet.png` | Purple bird wearing a red cycling helmet, standing upright | ★★★ | Yes — `public/img/illustrations/` | Wix brand set |
| `crocodile-on-tricycle.png` | Green crocodile-like character on a small tricycle | ★★★ | Yes — `public/img/illustrations/` | Wix brand set |
| `kid-on-bike-teal.png` | Child on a bike, teal colour variant | ★★★ | Yes — `public/img/illustrations/` | Wix brand set |
| `kid-on-bike.png` | Child on a bike, standard colour variant | ★★★ | Yes — `public/img/illustrations/` | Wix brand set |
| `kid-on-scooter.png` | Child riding a scooter | ★★★ | Yes — `public/img/illustrations/` | Wix brand set |
| `kid-waving.png` | Child waving from a bike | ★★★ | Yes — `public/img/illustrations/` | Wix brand set |
| `person-with-boombox.png` | Person leaning against a bike with a boombox/radio | ★★★ | Yes — `public/img/illustrations/` | Wix brand set |
| `tree-round.png` | Decorative round-canopy tree | ★★★ | Yes — `public/img/illustrations/` | Wix brand set |
| `tree-tall.png` | Decorative tall tree | ★★★ | Yes — `public/img/illustrations/` | Wix brand set |
| `chapter-map-brussels.png` | Diagram of all 12 Brussels chapters shown as coloured circles on an outline map of the Brussels Region; each circle labelled with postal code range and "Kidical mass" | ★★ | No | `cf0153_86a74b358a31496dbe686d06061ff719~mv2.png` |
| `volunteer-sign-character.png` | Cartoon safety-volunteer character (older woman in yellow vest) holding a pink heart sign — matches chapter poster illustration style | ★★ | No | `cf0153_626591a098b0457182da5ee354fcd0c9~mv2.png` |
...
| Filename | Description | Dimensions | Quality | In use | Source |
|----------|-------------|------------|---------|--------|--------|
| `event-big-kidical-mass-2026-banner.jpg` | Big Kidical Mass 2026 banner; illustrated characters on bright blue; "Su 10th May · BXL · Place Troon" | 985×477 | ★★★ | No | `Banner-Grote Kidical 2026.jpg` |
| `event-big-kidical-mass-2026-website-banner.jpg` | Wider crop of same 2026 illustration; website-optimised ultra-wide format | 980×335 | ★★ | No | `Banner-website-Kidical-2026.jpg` |
| `event-big-kidical-mass-2025-banner.jpg` | Big Kidical Mass BXL 04.05.2025 banner; illustrated crowd scene; sponsor strip at bottom | 711×443 | ★★★ | No | `banner_big Kidical 2025 2.jpg` |
| `event-big-kidical-mass-2025-poster.jpg` | A2-style portrait poster for 04.05.2025 BXL event; illustrated; sponsor strip | 371×525 | ★★★ | No | `cf0153_b69c3b133fe04ee6bbd9aef205af82b0~mv2.jpg` |
| `event-big-kidical-mass-2024-banner.jpg` | Big Kidical Mass 06.10.24 Brussels banner; illustrated animal characters; pink/teal/coral palette | 784×490 | ★★★ | No | `Banner_Big Kidical Mass 2024 final.jpg` |
| `event-big-kidical-mass-2024-poster.jpg` | A2 portrait poster for 06.10.2024 BXL event; same illustrated animal characters | 600×849 | ★★★ | No | `Affiche A2 Big Kidical Mass 2024 FINAL.jpg` |
| `event-big-kidical-mass-2023-banner.jpg` | Big Kidical Mass 10 Sep banner; illustrated crowd; "Village Vélo" info; pre-2024 style | 769×481 | ★★ | No | `Banner Kidical Mass 10 september.jpg` |
| `event-end-of-year-party.jpg` | End-of-year party poster "Fête fin d'année / Eindejaarsfeest — Kidical Mass, Thu 11 Dec, Palazzo"; dark gradient background, bright typography | 740×417 | ★★★ | No | `cf0153_09071f6ee2814bb6a72390e5a308900c~mv2.jpg` |
| `event-meetup-season-launch.jpg` | Season Launch Meetup #1 "Apéro des Gilets Roses / van de Roze Hesjes"; photo + illustration composite | 740×494 | ★★★ | No | `cf0153_c10c642fc6c64ec79c475cb15a847b32~mv2.jpg` |
| `event-meetup-drink-gourmand.jpg` | Meetup #2 "Drink Gourmand des Gilets Roses" at Brasserie Mazette; group photo | 740×494 | ★★★ | No | `cf0153_84a1eb5c844446e2b6804ad5609b78d9~mv2.jpg` |
| `event-route-map-2023.jpg` | Illustrated route map for 2023 Big Kidical Mass showing cycle paths in Brussels; Kidical Mass branding overlay | 672×485 | ★★ | No | `cf0153_ec01afb12d664c22ae473a63ebf90b37~mv2.jpg` |

### Chapter posters

All 12 "Viens rouler avec nous / Kom mee fietsen!" municipality flyers. Consistent layout: coloured background, illustrated characters, municipality name + postal code, Kidical Mass branding. All are Wix thumbnails (~200×281 px) — originals likely exist at A5/A4 print resolution.

| Filename | Municipality | Postal code | Background colour | Quality |
|----------|-------------|-------------|-------------------|---------|
| `chapter-anderlecht.png` | Anderlecht | 1070 | Purple | ★★ |
| `chapter-bruxelles-ville.png` | Bruxelles-Ville / Brussel-Stad | 1000 | Orange | ★★ |
| `chapter-etterbeek.png` | Etterbeek | 1040 | Dark purple | ★★ |
| `chapter-forest.png` | Forest / Vorst | 1190 | Pink | ★★ |
| `chapter-ixelles.png` | Ixelles / Elsene | 1050 | Mint green | ★★ |
| `chapter-jette.png` | Jette | 1090 | Teal | ★★ |
| `chapter-koekelberg-ganshoren-berchem.png` | Koekelberg / Ganshoren / Berchem-Saint-Agathe | 1081–1082–1083 | Red | ★★ |
| `chapter-neder-over-heembeek.png` | Neder-Over-Heembeek | 1120 | Light blue | ★★ |
| `chapter-saint-gilles.png` | Saint-Gilles / Sint-Gillis | 1060 | Olive green | ★★ |
| `chapter-schaerbeek.png` | Schaerbeek / Schaarbeek | 1030 | Green | ★★ |
| `chapter-watermael-auderghem.png` | Watermael-Boitsfort / Auderghem | 1160–1170 | Dark navy | ★★ |
| `chapter-woluwe.png` | Woluwe-Saint-Pierre / Woluwe-Saint-Lambert | 1150–1200 | Yellow-green | ★★ |
...
| Filename | Description | Dimensions | Quality | In use | Source |
|----------|-------------|------------|---------|--------|--------|
| `partner-bruxelles-mobilite-fr.png` | Bruxelles Mobilité "Avec le soutien de" lockup (French), green heart logo, white background | 337×113 | ★★★ | Yes — `public/img/sponsors/bm-fr.avif` | `Logo Sponsoring_FR_CMYK_POS.png` |
| `partner-bruxelles-mobilite-nl.png` | Brussel Mobiliteit "Met de steun van" lockup (Dutch), same mark | 337×113 | ★★★ | Yes — `public/img/sponsors/bm-nl.avif` | `Logo Sponsoring_NL_CMYK_POS.png` |
| `partner-logos-composite-2024.png` | Full horizontal strip of all 2024 partner logos (Bike for Brussels, Cyclo, Farm, Monkey Money, Pro Velo, My Kids Bikes, REM, Loopz, Fiets Bieb, GRACiB, Fietsersbond, and ~15 more) | 956×145 | ★★ | No | `logos Affiche - Kidical BXL 2024 final v2.png` |

**Kidical Mass brand logos** (wordmark, icon, footer variants) live in `public/img/` and are all in active use: `logo.svg`, `logo.png`, `logo-color.png`, `logo-white.png`, `logo-icon.png`, `logo-footer.png`, `footer-logo.avif`, `footer-biker.avif`.
