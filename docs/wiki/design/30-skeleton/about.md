...
- **"Become a partner" → a real conversion flow, not a mailto.** The **Sponsorformules** + **Partnercharter** PDFs *do exist* (live Wix docs — a two-track tier ladder €100–2.500/yr + a values/terms charter; full content in [`partners.md` § conversion flow](partners.md#become-a-partner-conversion-flow--plan-2026-06-03)). Plan (Frederik 2026-06-03): replace the black-hole mailto with an **on-page summary of the two formule-tracks + downloadable PDFs + a routed form** (PAT-6, email/phone fallback). Prices are **provisional pending Leticia's national-scope OK** (these are a *KM Brussels* artifact) — couples to [D-11](../01-concerns.md).
