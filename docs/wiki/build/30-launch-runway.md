...
| **About polish batch** | Three bounded review follow-ups in one thread: About hub (P-14) look-en-feel lighter, design alternatives asked; Organisation (P-17) blue national-vs-local band simplified; News (P-18) category label onto the image (date jumps now), concrete page title, intro into the hero. Handoff brief ready: [`about-polish-batch.md`](../design/30-skeleton/about-polish-batch.md). | ●● | S–M | Frederik |
