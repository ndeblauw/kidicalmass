...
| **Performance pass** | Static photography ships raw (300–700 KB per image in `public/img`); model media is already responsive. Compress + one Lighthouse round. | ●● | S | Frederik |
